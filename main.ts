...
let Quote1: string ="laughing face do not mean that there is absence of sorrow! But it means that they have the ability to deal with it..\n";
...
let Quote2: string ="No legacy is so rich as honesty";
...
let familyMembers: string[] =[`Mustafa`,`Amna`,`Ahmed`,`Anabia`,`Anshra`,`Saad`];
...
let Members: string[] =[`Mustafa  `,`Amana  `,`Ahmed  `,`Anabia  `,`Anshra  `,`Saad  `];
let Message: string= `Did you completed 45 questions?`;
...
let transpotations: string [] =[ " civic"," bike"," BMW"," sport bike"];
...
let Guest_list1 : string[] = [`Hussain`,`Hamza`,`Ameer`,`Umer`,`Hassan`];
...
let Guest_list2 : string[] = [`Hussain`,`Hamza`,`Ameer`,`Umer`,`Hassan`];
for(let i=0; i<Guest_list2.length; i++){
    console.log(`Respected czns, `+Guest_list2[i]+ ',\nWe invited you on dinner tomorrow.\nThank you\n');
}
let not_present1 : string='Hamza';
...
let Guest_list : string[] = [`Hussain`,`Hamza`,`Ameer`,`Umer`,`Hassan`];
